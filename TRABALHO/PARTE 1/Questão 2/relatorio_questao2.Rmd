...
AS duas espécies foram consideradas morfologicamente similares e por prat de tempo foram consideradas como uma única espécie. O Objetivo geral desta análise é verificar possíveis distinções entre espécies. Além disso, especificamente, queremos realizar a análise de componentes principais para realizar tal tarefa. Faremos também uma análise de regressão utilizando a primeira componente. 
