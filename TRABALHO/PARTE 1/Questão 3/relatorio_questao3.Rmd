...
packages= c("tidyverse","data.table","reshape2","captioner","gridExtra","xtable","MASS","xtable","knitr","kableExtra","quadprog","scales","ca","mice","Matrix","pander", "formattable","forecast","factoextra")
...
Na Tabela 6, apresentamos os resultados obtidos via Análise de Correspondência Simples. Observamos que  `r result_var[2,4]` % da variablidade é explicada pelas duas prmeiras componentes, uma quantdade razoável que nos leva a considerarmos apenas elas para as próxmas análises.
...
Podemos ver que primeramente há uma relação de dependência entre as duas variáveis analisadas, *Saúde Mental* e *Status Sócio-Econômico dos Pais*, verificadas atráves do Teste Qu-Quadrado. Com o perfl das lnhas e colunas, conjecturamos alguns padrões que poderiam ser identificadas atráves da Análise de Correspondênca. 
