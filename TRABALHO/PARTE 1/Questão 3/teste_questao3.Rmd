...
packages= c("tidyverse","data.table","reshape2","captioner","gridExtra","xtable","MASS","xtable","knitr","kableExtra","quadprog","scales","ca","mice","Matrix","pander")
...
kable(round(mental2/sum(mental3)*100,2), format = "latex", booktabs = T)%>%kable_styling(position = "center")

```



Na Tabela 3, há o rankeamento para cada variável. Como podemos observar que 
